...
function EventCard({ event, onCTAClick, index = 0 }) {
    ...
    return (
        <div
            ...
            className={`relative overflow-hidden rounded-3xl bg-slate-50 flex flex-col items-center gap-4 p-6 md:w-xs w-full h-full event-card shadow-lg border-2 border-(--border-light) hover:border-(--primary-teal) group transition-all duration-700 ease-out 
